...
* *Code contributed*: [https://github.com/CS2103JAN2018-F09-B3/main/tree/master/collated/functional/ewaldhew.md[Functional code]] [https://github.com/CS2103JAN2018-F09-B3/main/tree/master/collated/test/ewaldhew.md[Test code]]
...
** Documentation:
*** Edited layout and language of the Developer and User Guides:
*** Updated diagrams in the Developer Guide: https://github.com[#14]
** Community:
